                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $blogsCount }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div
                                    ...
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                            ...
                                            <a class="dropdown-item" href="#">Export Chart Data</a>
...
<script>
    ...
    var myChart = new Chart(ctx, {
        type: 'bar', // Bar chart to show service bookings
        data: {
            labels: ["Babysitting", "Nursing", "Elderly Care"], // Example service types
            datasets: [{
                label: "Number of Bookings",
                data: [35, 50, 20], // Example data: replace with database values
                backgroundColor: [
                    "#FF6384", // Babysitting
                    "#36A2EB", // Nursing
                    "#FFCE56"  // Elderly Care
