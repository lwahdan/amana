        ...
        <div class="row col-md-12">
            ...
            <div class="col-md-4">
                <div class="flex flex-col items-center text-center">
                    <img src="{{ asset('storage/' . $provider->profile_picture) }}" alt="{{ $provider->name }}" class="profile-image">
                ...
                <tbody>
                    @foreach ($bookings as $booking)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('bookings.edit', $booking->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
        ...
        @else
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    @elseif ($review->status == 'dissapproved') bg-danger @endif">
                                    {{ ucfirst($review->status) }}
                                </span>
                            </td>
                            <td>
                                <a href="{{ route('reviews.index', $review->id) }}" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
