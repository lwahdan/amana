            ...
            <tbody>
                @forelse ($blogs as $blog)
                    <tr>
                        ...
                        <a href="{{ route('provider.blogs.edit', $blog->id) }}" class="btn btn-warning btn-sm"><i class="fa-regular fa-pen-to-square"></i></a>
                        <form method="POST" action="{{ route('provider.blogs.destroy', $blog->id) }}" style="display:inline;">
                            @csrf
                            @method('DELETE')
